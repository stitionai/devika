...
<div class="expandable-input relative mt-4">
	<textarea
		id="message-input"
		class="w-full rounded bg-slate-800 p-2 pr-20"
	...
	></textarea>
	<div class="token-count absolute bottom-2 right-2 text-xs text-gray-400">0 tokens</div>
	<button
		id="send-message-btn"
		class={`mt-2 w-full rounded px-4 py-2 ${isAgentActive ? "bg-slate-800" : "bg-indigo-700"}`}
