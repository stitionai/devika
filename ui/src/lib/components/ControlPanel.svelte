...
<div class="control-panel rounded border border-indigo-700 bg-slate-900">
	<Dropdown
	...
	>
		<div slot="prefix-entries" let:closeDropdown={close}>
			<button
				class="block w-full overflow-clip px-4 py-2 text-left text-sm text-white hover:bg-slate-700"
